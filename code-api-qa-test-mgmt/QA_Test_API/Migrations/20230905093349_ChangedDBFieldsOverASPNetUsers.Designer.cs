...
namespace QA_Test_Log.Migrations
{
    ...
    [Migration("20230905093349_ChangedDBFieldsOverASPNetUsers")]
    partial class ChangedDBFieldsOverASPNetUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QA_Test_Log.Controllers.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("QA_Test_Log.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("QA_Test_Log.Controllers.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("QA_Test_Log.Models.TestResult", b =>
                {
                    ...
                    b.HasOne("QA_Test_Log.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
